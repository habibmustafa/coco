...
import { FormDescription, FormLabel, FormMessage } from '../../atoms/forms/form'
              ...
              <div
                className={cn(
                  NonBoxInputContainer({
                    nonBoxInput,
                    // @ts-expect-error upstream: `label` is not one of NonBoxInputContainer's declared variant keys
                    label,
                    layout,
                  })
                )}
