 ...
 * Source: github.com/supabase/supabase/blob/master/packages/ui/src/components/shadcn/ui/select.tsx
 * Changes: hybrid API migration (docs/hybrid-api-migration.md) — root renamed
 * Select → SelectRoot so the atom's default export can become props-driven.
