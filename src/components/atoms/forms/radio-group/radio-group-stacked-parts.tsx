...
export type RadioGroupStackedRootProps = React.ComponentPropsWithoutRef<typeof RadioGroupPrimitive.Root>

const RadioGroupStackedRoot = React.forwardRef<
  React.ElementRef<typeof RadioGroupPrimitive.Root>,
  RadioGroupStackedRootProps
>(({ className, ...props }, ref) => {
  return (
...
RadioGroupStackedRoot.displayName = 'RadioGroupStacked'
...
export { RadioGroupStackedRoot, RadioGroupStackedItem }
