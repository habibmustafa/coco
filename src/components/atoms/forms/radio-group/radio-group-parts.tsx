 ...
 * RadioGroup → RadioGroupRoot so the atom's default export can become props-driven.
...
export interface RadioGroupLargeItemProps {
...
export { RadioGroupRoot, RadioGroupItem, RadioGroupLargeItem }
