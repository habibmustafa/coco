 ...
 * Source: github.com/supabase/supabase/blob/master/packages/ui/src/components/shadcn/ui/dropdown-menu.tsx
 * Changes: hybrid API migration (docs/hybrid-api-migration.md) — root renamed
 * DropdownMenu → DropdownMenuRoot so the atom's default export can become props-driven.
