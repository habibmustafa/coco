 ...
 * Source: github.com/supabase/supabase/blob/master/packages/ui/src/components/shadcn/ui/sheet.tsx
 * Changes: hybrid API migration (docs/hybrid-api-migration.md) — root renamed
 * Sheet → SheetRoot so the atom's default export can become props-driven.
